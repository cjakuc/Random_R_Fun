---
title: "Recreating Simply Stats Cool Plots"
author: "Chris Jakuc"
date: "12/11/2019"
...
dat <- tibble(country = toupper(c("US", "Italy", "Canada", "UK", "Japan", "Germany", "France", "Russia")),
              ...
              # Adding country codes for flags later!
...
dat %>% mutate(country = reorder(country, -count)) %>%
  ...
  # Adding in the flags using the country codes, so cool!!
...
dat %>% 
  ...
  # 'geom_text' puts the numbers on top of the bars
  geom_text(nudge_y = 0.2,  size = 3) +
  xlab("") + ylab("") + 
  # 'toupper' puts it in all uppercase
